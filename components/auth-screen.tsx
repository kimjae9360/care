        ...
        <div className="w-full max-w-md">
          <div className="rounded-2xl border border-border bg-card p-8 shadow-sm">
              ...
              <div className="flex flex-col gap-2">
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    defaultValue="kim.jaewon@caresignal.kr"
                    placeholder="이메일 또는 직원 ID 입력"
                    className="w-full rounded-xl border border-input bg-background py-2.5 pl-10 pr-3 text-sm text-foreground outline-none transition focus:border-ring focus:ring-2 focus:ring-ring/30"
                  />
                </div>
              </div>
            ...
            <Button
              ...
              size="lg"
              onClick={onLogin}
              className="w-full rounded-xl border-primary/30 bg-accent text-accent-foreground hover:bg-accent/70"
            >
              <Sparkles className="h-4 w-4" aria-hidden />
              해커톤 데모 로그인
            </Button>
